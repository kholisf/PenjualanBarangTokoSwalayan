...
Module ReportModule
    ...
    Sub ReportNotaPenjualan2(ByVal NomorTransaksi As String, ByVal Tanggal As Date, ByVal JumlahUang As Double, ByVal Kembalian As Double, ByVal StatusCetak As Boolean, ByVal potongan As Double, ByVal totalsemua As Double, ByVal kodekonsumen As String)
        EksekusiQuery("create or replace view view_noteuntukkonsumen as select a.KodeBarang,b.NamaBarang,a.HargaSatuan,a.Jumlah,a.PersenDiskon,(a.HargaSatuan*a.Jumlah) as SubTotal,(a.HargaSatuan*a.Jumlah*(a.PersenDiskon/100)) as JumlahDiskon,(a.HargaSatuan*a.Jumlah)-(a.HargaSatuan*a.Jumlah*(a.PersenDiskon/100)) as JumlahHarga from (penjualan_detil a inner join barang b on a.KodeBarang=b.KodeBarang) where a.NomorTransaksi='" & NomorTransaksi & "' group by a.NomorTransaksi")
        Dim rpt As New rptNotePenjualan

        rpt.txtNomorTransaksi.Text = " " & NomorTransaksi
        rpt.txtTanggal.Text = " " & Tanggal
        rpt.tblKembalian.Text = " " & Format(Kembalian, "n0")
        rpt.tblPotongan.Text = " " & Format(potongan, "n0")
        rpt.tblJumlahUang.Text = " " & Format(JumlahUang, "n0")
        rpt.tblTotalSemua.Text = " " & Format(totalsemua, "n0")
        rpt.txtKonsumen.Text = " dengan Kode Konsumen " & kodekonsumen
    ...
    End Sub
    'Sub ReportNotaPenjualan(ByVal NomorTransaksi As String, ByVal Tanggal As Date, ByVal JumlahUang As Double, ByVal Kembalian As Double, ByVal StatusCetak As Boolean, ByVal potongan As Double, ByVal totalsemua As Double)
    '    Dim rpt As New rptNotePenjualan
